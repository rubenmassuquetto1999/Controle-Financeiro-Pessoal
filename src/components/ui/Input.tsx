    ...
    return (
      <div className="w-full space-y-1">
        ...
        <input
          ...
          ref={ref}
          className={cn(
            'flex h-9 w-full rounded-lg border border-slate-700 bg-[#09090b] px-3 py-2 text-xs text-slate-100 placeholder:text-slate-600 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/50 disabled:cursor-not-allowed disabled:opacity-50 transition-colors',
